...
public class Baumdarsteller 
{
     ...
     */
    public void zeige(SearchTree pBaum, int pLinks, int pRechts, int pOben)
    {
    ...
    private void zeigeTeilbaum(SearchTree pTeilbaum, int pVaterMitte, int pVaterUnten, int pLinks, int pRechts)
    {
   ...
   /**
     ...
     */
    public void zeige(SearchTree pBaum, int pLinks, int pRechts, int pOben, int pUnten)
    {
